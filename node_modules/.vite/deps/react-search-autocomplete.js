...
var require_SearchInput = __commonJS({
  "node_modules/react-search-autocomplete/dist/components/SearchInput.js"(exports) {
    ...
    function SearchInput(_a) {
      ...
      var maxLengthProperty = maxLength ? { maxLength } : {};
      return (0, jsx_runtime_1.jsxs)(StyledSearchInput, { children: [(0, jsx_runtime_1.jsx)(SearchIcon_1.SearchIcon, { showIcon }), (0, jsx_runtime_1.jsx)("input", __assign({ type: "text", ref, spellCheck: false, value: searchString, onChange: setSearchString, onFocus: handleOnFocus, placeholder, autoFocus, onBlur: function() {
        return eraseResults();
      }, onKeyDown: function(event) {
        return setHighlightedItem({ event });
      }, "data-test": "search-input" }, maxLengthProperty)), (0, jsx_runtime_1.jsx)(ClearIcon_1.ClearIcon, { showClear, setSearchString, searchString, onClear, setFocus })] });
    }
    ...
    function ReactSearchAutocomplete(_a) {
      ...
      var handleSetHighlightedItem = function(_a2) {
        ...
        var setValues = function(index2) {
          ...
          (results === null || results === void 0 ? void 0 : results[index2]) && onHover(results[index2]);
        };
        if (index !== void 0) {
      ...
      return (0, jsx_runtime_1.jsx)(styled_components_1.ThemeProvider, __assign({ theme }, { children: (0, jsx_runtime_1.jsx)(StyledReactSearchAutocomplete, __assign({ className }, { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: "wrapper" }, { children: [(0, jsx_runtime_1.jsx)(SearchInput_1.default, { searchString, setSearchString: handleSetSearchString, eraseResults, autoFocus, onFocus: handleOnFocus, onClear, placeholder, showIcon, showClear, setHighlightedItem: handleSetHighlightedItem, maxLength }), (0, jsx_runtime_1.jsx)(Results_1.default, { results, onClick: handleOnClick, setSearchString, showIcon, maxResults, resultStringKeyName, formatResult, highlightedItem, setHighlightedItem: handleSetHighlightedItem, showNoResultsFlag, showNoResultsText })] })) })) }));
    }
